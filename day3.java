...
public class day3 {
    ...
    public static int runPartOne() throws FileNotFoundException {
        ...
        // [DOING] If a symbol was found, check the 9 x 9 area around the symbol for digits
        ...
        for (int i = 0; i < fileData.size(); i++) {
            ...
            for (char key: symbolMapping.keySet()) {
                ArrayList<ArrayList<Integer>> generatedIndices = generateIndices(i, symbolMapping.get(key), totalFileLines);
                System.out.println(String.format("Symbol: %c | X: %d | Y: %d", key, i, symbolMapping.get(key)));
